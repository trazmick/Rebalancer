...
@property (nonatomic, readonly) NSString *symbol; //NEED THIS!
@property (nonatomic, readonly) NSString *lastTradePriceOnly; //NEED THIS!
@property (nonatomic, readonly) NSString *changeinPercent; //THIS MIGHT BE NICE TO HAVE
